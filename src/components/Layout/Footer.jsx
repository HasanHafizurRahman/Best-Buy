            ...
            <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form class="w-full">
                ...
                <div class="border border-gray-100 p-2 focus-within:ring dark:border-gray-800 sm:flex sm:items-center sm:gap-4">
                  ...
                  <button class="mt-1 w-full bg-teal-500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:flex-shrink-0">
                    Sign Up
                  </button>
                </div>
              </form>
            ...
            <nav aria-label="Footer Navigation - Support" class="mt-8 sm:mt-0">
              <ul class="flex flex-wrap justify-start gap-4 text-xs lg:justify-end">
                <li>
                  <a
                    href="#"
                    class="text-gray-400 transition hover:opacity-75 dark:text-gray-400"
                  >
                    Terms & Conditions
                  </a>
                </li>
